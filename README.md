...
Source Code is 'main.cpp' in the new branch
...
"screen -s " creates a new process
...
"report-util" generate the CPU utlization report

"process-smi" show summarized view of memory usage per process

"vmstat" display detailed memory statistics

To run in the command in the command prompt: Input 'g++ main.cpp -o main.exe' Input 'main.ex
